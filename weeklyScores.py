...
def getWeeklyScores(year):
    ...
    scores_df.loc[(scores_df['Name'] == 'Colin') & (scores_df['Team'] == "Cohen's Tough Team"), 'Name'] = 'Cohen'
    scores_df.loc[(scores_df['Name'] == 'Colin') & (scores_df['Team'] != "Brick'd Up"), 'Name'] = 'Cohen'
    # Save to CSV
